...
const routes = [
  ...
  { path: '/outil-pdf/:slug', name: ROUTE_TYPE.PDF_OUTIL_GENERATOR, component: PdfGeneratorLink },
  { path: '/glossaire-pdf', name: ROUTE_TYPE.PDF_GLOSSAIRE_GENERATOR, component: PdfGeneratorLink },
  { path: '/fiche-pdf/:slug', name: ROUTE_TYPE.PDF_FICHE_GENERATOR, component: PdfGeneratorLink },
